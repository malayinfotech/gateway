...
var (
	...
	ErrBandwidthLimitExceeded = miniogo.ErrorResponse{
		Code:       "XStorxBandwidthLimitExceeded",
		StatusCode: http.StatusForbidden,
		Message:    "You have reached your Storx project bandwidth limit on the Satellite.",
	}
	...
	ErrStorageLimitExceeded = miniogo.ErrorResponse{
		Code:       "XStorxStorageLimitExceeded",
		StatusCode: http.StatusForbidden,
		Message:    "You have reached your Storx project storage limit on the Satellite.",
	}
	...
	ErrSegmentsLimitExceeded = miniogo.ErrorResponse{
		Code:       "XStorxSegmentsLimitExceeded",
		StatusCode: http.StatusForbidden,
		Message:    "You have reached your Storx project segment limit on the Satellite.",
	}

	// ErrInvalidTTL indicates that the value under
	// X-Amz-Meta-Storx-Expires/X-Minio-Meta-Storx-Expires couldn't be parsed.
	ErrInvalidTTL = miniogo.ErrorResponse{
		Code:       "XStorxInvalidTTL",
...
// NewStorxGateway creates a new Storx S3 gateway.
func NewStorxGateway(compatibilityConfig S3CompatibilityConfig) *Gateway {
	return &Gateway{
...
// ConvertError translates Storx-specific err associated with object to
...
func parseTTL(userDefined map[string]string) (time.Time, error) {
	date, ok := userDefined["X-Amz-Meta-Storx-Expires"]
	if !ok {
		if date, ok = userDefined["X-Minio-Meta-Storx-Expires"]; !ok {
