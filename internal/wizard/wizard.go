...
var (
	satellites = []string{
		"12EayRS2V1kEsWESU9QMRseFhdxYxKicsiFmxrsLZHeLUtdps3S@us1.storx.io:7777",
		"12L9ZFwhzVpuEKMUNUqkaTLGzwY9G24tbiigLiXpmZWKwmcNDDs@eu1.storx.io:7777",
		"121RTSDpyNZVcEU84Ticf2L1ntiuUimbWgfATz21tuvgk3vzoA6@ap1.storx.io:7777",
	}
	...
	SatellitesURL = map[string]string{
		...
		"us1.storx.io":                satellites[0],
		"eu1.storx.io":                satellites[1],
		"ap1.storx.io":                satellites[2],
	}
)
...
func PromptForSatellite(cmd *cobra.Command) (string, error) {
	...
	for iterator, value := range satellites {
		nodeURL, err := storx.ParseNodeURL(value)
		if err != nil {
			return "", err
		}
	...
	nodeURL, err := storx.ParseNodeURL(satelliteAddress)
	if err != nil {
		return "", err
	}
...
func PromptForTracing() (bool, error) {
	_, err := fmt.Printf(`
With your permission, Storx DCS can automatically collect anonymized analytics information from your S3 Gateway and send it to Storx Labs (makers of Storx DCS) to help improve the quality and performance of our products.
Do you agree to submit such information to Storx Labs (y/N): `)
	if err != nil {
		return false, err
	}
